...
<<<<<<< HEAD
  return (
    <section className="max-w-[1024px] mx-auto px-8 py-24">
      <h2 className="text-5xl font-bold text-foreground mb-16">Experience</h2>

      <div className="space-y-6">
        {experiences.map((exp, index) => (
          <div key={index} className="bg-card/50 border border-border rounded-2xl p-8 hover:bg-card transition-colors">
